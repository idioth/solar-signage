        ...
        <div class="card">
            ...
            <div class="card-body p-0 pt-2 pb-2">   
                  ...
                  <div class="row">
                        ...
                        <div class="col-sm-4">
                             <div class="item text-left ">
                                <h5 class="m-1 pb-0"><small>Power (W)</small></h5> 
                            </div>
                        </div> 
                        <div class="col-sm-4">
                            <div class="item text-center">
                                <!-- <span class="badge badge-dark">{{ power }}</span> -->
                                <h5 class="m-1 pb-0"><small>{{ power }}</small></h5>
                            </div> 
                        </div>   
                  </div>
                  ...
                  <div class="row">
                        ...
                        <div class="col-md-4">
                             <div class="item text-left">
                                <h5 class="m-1 pb-0"><small>Level</small></h5> 
                            </div>
                        </div> 
                        <div class="col-md-4">
                            <div class="item text-center">
                  ...
                  <div class="row">
                      <div class="col-md-2">
                        ...
                        <div class="col-md-4">
                             <div class="item text-left">
                                <h5 class="m-1 pb-1"><small>Current (A)</small></h5> 
                            </div>
                        </div> 
                        <div class="col-md-4">
                            <div class="item text-center">
                                <!-- <span class="badge badge-dark">{{ current }}</span> -->
                                <h5 class="m-1 pb-0"><small>{{ current }}</small></h5>
                            </div> 
                        </div> 
                  </div>
                  ...
                  <div class="row">
                        ...
                        <div class="col-md-4">
                             <div class="item text-left">
                                <h5 class="m-1 pb-1"><small>Voltage (V)</small></h5> 
                            </div>
                        </div> 
                        <div class="col-md-4">
                            <div class="item text-center">
                                <!-- <span class="badge badge-dark">{{ voltage }}</span> -->
                                <h5 class="m-1 pb-0"><small>{{ voltage }}</small></h5>
                            </div> 
                        </div> 
                  </div>
                    ...
                    <!--<div class="row">
                        ...
                        <div class="col-md-4">
                             <div class="item text-left">
                                <h5 class="m-0 pb-1"><small>Charging</small></h5> 
                            </div>     
                        </div>
                       
                        <div class="col-md-5">
                             
                                <h5 class="m-0 pb-0"><small><switchbutton 
                                            v-model="switch1"></switchbutton></small></h5>
